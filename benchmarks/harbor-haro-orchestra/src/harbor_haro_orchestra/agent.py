"""Harbor custom-agent entry point for Haro orchestration."""
...
from .container_runtime import HaroContainerRuntime, EndpointLaunchConfig


class HaroOrchestraAgent(BaseAgent):
    """Coordinate an arbitrary manifest-defined team through a Haro trial."""
    ...
    def _build_runtime(
        ...
        haro_acp_binary: str,
        haro_agent_binary: str,
        haro_dev_mcp_binary: str,
        haro_cli_binary: str,
        relay_gateway: str,
        ...
        return HaroContainerRuntime(
            ...
            endpoints=endpoints,
            haro_acp_binary=haro_acp_binary,
            haro_agent_binary=haro_agent_binary,
            haro_dev_mcp_binary=haro_dev_mcp_binary,
            haro_cli_binary=haro_cli_binary,
    ...
    async def run(
        ...
        if self.provisioner is None or self.runtime is None:
            raise RuntimeError(
                "HaroOrchestraAgent requires provisioner and runtime integrations; "
        ...
        context.metadata = {
            **result.metadata,
            ...
            "haro_channel_id": handle.channel_id,
            "run_id": run_id,
            "trial_id": trial_id,
        }
