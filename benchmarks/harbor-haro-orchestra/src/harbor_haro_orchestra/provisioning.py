"""Typed boundary between the Harbor adapter and Haro trial provisioning."""
...
class AgentCredential:
    """One trial-scoped Haro identity and attributed LLM credential."""
...
@dataclass(frozen=True, slots=True)
class TrialHandle:
    """Provisioned Haro resources owned by one Harbor trial."""
...
class TrialProvisioner(Protocol):
    """Creates and tears down trial-isolated Haro resources synchronously."""
