      ...
      <div className="flex w-full flex-1 gap-8 bg-[#F3F3F3] px-4 py-8 text-black dark:bg-[#171717] dark:text-white">
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-12 text-center">
            <BookmarkIcon className="mx-auto h-10 w-10 text-black/50 dark:text-white/50" />
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-6">
          <div className="flex items-center gap-3">
            <BookmarkIcon className="h-6 w-6 shrink-0 text-black/50 dark:text-white/50" />
