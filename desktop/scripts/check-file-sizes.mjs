...
const overrides = new Map([
  ...
  // +11: lucide-react → @solar-icons/react migration: multi-line import
  // formatting. Queued to split if refactored.
  ["src/features/profile/ui/AnimatedAvatarCapture.tsx", 1020],
  ...
  // +4: lucide-react → @solar-icons/react migration: multi-line import
  // formatting. Queued to split if refactored.
  ["src/features/channels/ui/ChannelPane.tsx", 1010],
  ...
  // +6: lucide-react → @solar-icons/react migration: multi-line import
  // formatting for icon imports. Queued to split if refactored.
  ["src/shared/ui/VideoPlayer.tsx", 2230],
  ...
  // +5: lucide-react → @solar-icons/react migration: multi-line import
  // formatting. Queued to split if refactored.
  ["src/features/agents/ui/AgentSessionTranscriptList.tsx", 1010],
