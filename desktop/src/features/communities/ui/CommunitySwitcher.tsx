...
function isConnectionDegraded(state: ConnectionState): boolean {
...
export function CommunitySwitcher({
  ...
  const connectionState: ConnectionState = "connected"; // TODO: wire to realtimeSocketClient
  const degraded = isConnectionDegraded(connectionState);
