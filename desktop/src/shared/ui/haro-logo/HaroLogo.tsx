...
import HaroLogoAnimation, {
  type HaroLogoAnimationProps,
} from "./HaroLogoAnimation";

export type HaroLogoProps = {
  ...
  pulse?: boolean;
  reverse?: boolean;
  variant?: HaroLogoAnimationProps["variant"];
};
...
export function HaroLogo({
  ...
  return (
    <HaroLogoAnimation
      ariaLabel={ariaLabel}
      className={cn(
        pulse && !fuzz && !hasRestWindow && "haro-logo--pulse",
        className,
      )}
      fullScreen={false}
      loop={loop}
