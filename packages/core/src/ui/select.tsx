...
import { AltArrowDownLinear, DoubleAltArrowDownLinear, AltArrowUpLinear } from 'solar-icon-set';
    ...
    return (
        <SelectPrimitive.Trigger
            ...
            <SelectPrimitive.Icon
                ...
                asChild>
                <DoubleAltArrowDownLinear className="size-3 opacity-50" />
            </SelectPrimitive.Icon>
        </SelectPrimitive.Trigger>
    )
}
...
function SelectScrollUpButton({ className, ...props }: React.ComponentProps<typeof SelectPrimitive.ScrollUpButton>) {
    return (
        <SelectPrimitive.ScrollUpButton
            ...
            {...props}>
            <AltArrowUpLinear className="size-4" />
        </SelectPrimitive.ScrollUpButton>
    )
}
