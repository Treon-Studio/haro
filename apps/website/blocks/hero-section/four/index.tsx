...
import { MusicNoteLinear, AltArrowRightLinear, GalleryLinear, LightbulbLinear, Microphone3Linear, PaperclipLinear, AddCircleLinear, BagLinear, TelescopeLinear } from 'solar-icon-set';
