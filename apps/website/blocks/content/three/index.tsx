import { LightbulbLinear, PenLinear, RulerPenLinear } from 'solar-icon-set';
            ...
            <div className="mx-auto max-w-2xl px-6">
                ...
                <div className="@xl:grid-cols-3 mt-12 grid grid-cols-2 gap-6 text-sm">
                    <div className="space-y-3 border-t pt-6">
                        <LightbulbLinear className="text-muted-foreground size-4" />
                    ...
                    <div className="space-y-3 border-t pt-6">
                        <PenLinear className="text-muted-foreground size-4" />
                        <p className="text-muted-foreground leading-5">
                    ...
                    <div className="space-y-3 border-t pt-6">
                        <RulerPenLinear className="text-muted-foreground size-4" />
                        <p className="text-muted-foreground leading-5">
