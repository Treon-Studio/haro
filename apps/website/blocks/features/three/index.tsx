...
import { CloudLinear, CPULinear, ShieldMinimalisticLinear, AltArrowRightLinear } from 'solar-icon-set';
                ...
                <div>
                    ...
                    <div className="mt-16 *:w-full *:cursor-pointer">
                        ...
                        <button
                            ...
                            className="not-data-[selected=true]:hover:text-foreground not-data-[selected=true]:text-muted-foreground flex items-center gap-3 py-2 text-sm">
                            <ShieldMinimalisticLinear className="size-4" />
...
const EnterpriseIllustration = () => {
    return (
        <div
            ...
            <ShieldMinimalisticLinear className="absolute inset-0 size-full stroke-[0.1px] opacity-15" />
            <ShieldMinimalisticLinear className="fill-card dark:fill-foreground/10 drop-shadow-black/3 stroke-border size-32 stroke-[0.2px] drop-shadow-xl" />
        </div>
    )
}
