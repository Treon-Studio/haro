...
import { ShieldMinimalisticLinear } from 'solar-icon-set';
                ...
                <div className="@xl:grid-cols-2 mt-12 grid gap-3 *:p-6">
                    ...
                    <Card
                        ...
                        <div className="pointer-events-none relative -ml-7 flex size-44 items-center justify-center pt-5">
                            <ShieldMinimalisticLinear className="absolute inset-0 top-2.5 size-full stroke-[0.1px] opacity-15" />
                            <ShieldMinimalisticLinear className="size-32 stroke-[0.1px]" />
                        </div>
                    </Card>
                </div>
            </div>
